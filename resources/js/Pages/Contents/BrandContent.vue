<template>
  <div class="card">
    <Toolbar class="mb-6">
      ...
      <DataTable v-model:filters="filters" :value="items" paginator showGridlines :rows="10" dataKey="id"
              filterDisplay="menu" :loading="loading" :globalFilterFields="['brand_name', 'brand_code', 'created_by', 'updated_by']">
          <template #header>
