      ...
      <div class="col-span-4">
        <div class="mb-1">
          <div class="flex items-center mb-1">
            ...
            <div class="flex-1">
              <InputText v-model.trim="item.unit_stk" class="w-full" value="KG" disabled/>
            </div>
          </div>
        </div>
      </div>
      <div class="col-span-2">
        <div class="mb-1">
          <div class="flex items-center mb-1">
            ...
            <div class="flex-1">
              <InputText v-model.trim="item.level_code" class="w-full" value="N" disabled />
            </div>
          </div>
        </div>
      </div>
      <div class="col-span-2">
        <div class="mb-1">
          <div class="flex items-center mb-1">
            ...
            <div class="flex-1">
              <InputText v-model.trim="item.unit_prod" class="w-full" value="KG" disabled/>
            </div>
          </div>
        </div>
      </div>
